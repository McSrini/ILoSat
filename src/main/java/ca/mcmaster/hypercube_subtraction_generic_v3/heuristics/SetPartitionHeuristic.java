...
import ca.mcmaster.hypercube_subtraction_generic_v3.bcp.SetPartition_BCP_Propogator;
 ...
 * @author tamvadss
 */
public class SetPartitionHeuristic extends SteppedHeuristic{
    
    //method can be moved into base class
    ...
    private List<String> selectCandidatesWithBest_BCP (Set<String>  vars, 
        ...
        return ( new SetPartition_BCP_Propogator (vars, filterResult) ).performBCP();
    }
}
